...
def base64_encrypt_and_sign_str(encryption_key_b64: str, recv_pub_key_b64: str, signing_key_b64: str, data: str) -> str:
    signing_key = SigningKey(signing_key_b64.encode("utf-8"), encoder=Base64Encoder)
    encryption_key = PrivateKey(encryption_key_b64.encode("utf-8"), encoder=Base64Encoder)
    ...
    # Encrypt data
    encrypted_data = encrypt(recv_pub_key, encryption_key, signed_data, encoder=Base64Encoder)
