...
def encrypt(public_key: PublicKey, private_key: PrivateKey, data: bytes, encoder=Base64Encoder) -> bytes:
    """
...
def decrypt(public_key: PublicKey, private_key: PrivateKey, data: bytes, encoder=Base64Encoder) -> bytes:
    """
